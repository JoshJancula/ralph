<!-- GENERATED from bundle/.agents/agents/code-review/code-review.md by scripts/sync-plugin-assets.sh - edit the canonical file -->
---
name: code-review
description: Reviews changed code for correctness, security, and convention compliance before downstream delivery.
model: inherit
---
<!-- GENERATED from .agents/agents/code-review.md by scripts/sync-runtime-assets.sh - edit the canonical file -->
