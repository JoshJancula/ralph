<!-- GENERATED from bundle/.agents/agents/security/security.md by scripts/sync-plugin-assets.sh - edit the canonical file -->
---
name: security
...
model: inherit
---
<!-- GENERATED from .agents/agents/security.md by scripts/sync-runtime-assets.sh - edit the canonical file -->
