<!-- GENERATED from bundle/.agents/agents/research/research.md by scripts/sync-plugin-assets.sh - edit the canonical file -->
---
name: research
description: Explores relevant docs and code paths, then summarizes findings for downstream agents.
model: inherit
---
<!-- GENERATED from .agents/agents/research.md by scripts/sync-runtime-assets.sh - edit the canonical file -->
