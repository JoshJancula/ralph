<!-- GENERATED from bundle/.agents/agents/implementation/implementation.md by scripts/sync-plugin-assets.sh - edit the canonical file -->
---
name: implementation
...
model: inherit
---
<!-- GENERATED from .agents/agents/implementation.md by scripts/sync-runtime-assets.sh - edit the canonical file -->
