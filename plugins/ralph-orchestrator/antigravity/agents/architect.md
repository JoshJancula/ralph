<!-- GENERATED from bundle/.agents/agents/architect/architect.md by scripts/sync-plugin-assets.sh - edit the canonical file -->
---
name: architect
...
model: inherit
---
<!-- GENERATED from .agents/agents/architect.md by scripts/sync-runtime-assets.sh - edit the canonical file -->
