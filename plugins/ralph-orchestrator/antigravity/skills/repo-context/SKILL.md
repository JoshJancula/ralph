<!-- GENERATED from bundle/.agents/skills/repo-context/SKILL.md by scripts/sync-plugin-assets.sh - edit the canonical file -->
---
name: repo-context
...
- Language/runtime versions (from version files, container images, or similar).
