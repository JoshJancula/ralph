<!-- GENERATED from bundle/.claude/agents/implementation/implementation.md by scripts/sync-plugin-assets.sh - edit the canonical file -->
---
name: implementation
description: >-
...
tools:
  ...
  - Bash
skills:
  - ${CLAUDE_PLUGIN_ROOT}/skills/repo-context/SKILL.md
---
