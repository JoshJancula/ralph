#!/usr/bin/env bash
# GENERATED from bundle/.codex/hooks/post-tool-native-result-compact.sh by scripts/sync-plugin-assets.sh - edit the canonical file
...
#
# Fast path: when neither gate env is truthy, exit 0 before exec/source.
