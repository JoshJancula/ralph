...
data = {
    ...
    "mcp_config_sources": _ml("RUNTIME_OVERLAY_SUMMARY_MCP_CONFIG_SOURCES_VALUE", "mcp_config_sources"),
    "mcp_effective_names": _ml("RUNTIME_OVERLAY_SUMMARY_MCP_EFFECTIVE_NAMES_VALUE", "mcp_effective_names"),
    "mcp_override_decisions": _ml("RUNTIME_OVERLAY_SUMMARY_MCP_OVERRIDE_DECISIONS_VALUE", "mcp_override_decisions"),
    "mcp_failure_reason": _ms_or_empty("RUNTIME_OVERLAY_SUMMARY_MCP_FAILURE_REASON_VALUE", "mcp_failure_reason"),
