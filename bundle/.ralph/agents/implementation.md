...
skills:
  - repo-context
output_artifacts:
  - ".ralph-workspace/artifacts/{{ARTIFACT_NS}}/implementation-handoff.md|required|notes"
  - ".ralph-workspace/artifacts/{{ARTIFACT_NS}}/architecture.md|optional"
  - ".ralph-workspace/handoffs/{{ARTIFACT_NS}}/implementation-to-qa.md|optional|handoff|qa"
---
## Role
