...
Deliver your conclusions as `.agents/artifacts/{{ARTIFACT_NS}}/research.md`. Use that artifact to capture structured notes, conclusions, and suggested follow-up steps. Follow the project rules (no emoji, plain ASCII), keep summaries concise, and call out any constraints you observe while researching.
