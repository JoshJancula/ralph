...
setup_orchestrator_mcp_workspace() {
  ...
  cp "$RALPH_DIR/bash-lib/orchestrator/orchestrator-router.sh" "$workspace/.ralph/bash-lib/orchestrator/"
  cp "$RALPH_DIR/bash-lib/orchestrator/orchestrator-planner.sh" "$workspace/.ralph/bash-lib/orchestrator/"
