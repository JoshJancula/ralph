...
#   6. Stages
#   7+ Per stage: inline/planFile choice, runtime, agent, content, verification, context budget
...
@test "orchestration wizard can configure parallelStages" {
...

  {
    ...
    # Stage research (inline; agent default model used, no model prompt):
    printf '\n'   # inline
    printf '\n'   # runtime (cursor)
    printf '\n'   # agent (research)
    printf '\n'   # content
